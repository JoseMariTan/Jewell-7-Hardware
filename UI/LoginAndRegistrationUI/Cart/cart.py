...
"")
        ...
        self.add_to_cart_button_4 = QtWidgets.QPushButton(Cart_Tab)
        self.add_to_cart_button_4.setMinimumSize(QtCore.QSize(175, 50))
        self.add_to_cart_button_4.setMaximumSize(QtCore.QSize(400, 60))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(8)
        font.setBold(True)
...
"")
        ...
        self.add_to_cart_button_4.setIcon(icon1)
        ...
        self.add_to_cart_button_2 = QtWidgets.QPushButton(Cart_Tab)
        self.add_to_cart_button_2.setMinimumSize(QtCore.QSize(175, 50))
        self.add_to_cart_button_2.setMaximumSize(QtCore.QSize(400, 60))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(8)
        font.setBold(True)
        font.setWeight(75)
        font.setStrikeOut(False)
        self.add_to_cart_button_2.setFont(font)
        self.add_to_cart_button_2.setMouseTracking(True)
        self.add_to_cart_button_2.setTabletTracking(True)
        self.add_to_cart_button_2.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.add_to_cart_button_2.setStyleSheet("QPushButton {\n"
...
"border:none;\n"
"")
        self.add_to_cart_button_2.setIcon(icon1)
        self.add_to_cart_button_2.setIconSize(QtCore.QSize(22, 22))
        self.add_to_cart_button_2.setObjectName("add_to_cart_button_2")
        self.horizontalLayout.addWidget(self.add_to_cart_button_2)
        self.add_to_cart_button_3 = QtWidgets.QPushButton(Cart_Tab)
        self.add_to_cart_button_3.setMinimumSize(QtCore.QSize(175, 50))
        self.add_to_cart_button_3.setMaximumSize(QtCore.QSize(400, 60))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(8)
        font.setBold(True)
        font.setWeight(75)
        font.setStrikeOut(False)
        self.add_to_cart_button_3.setFont(font)
        self.add_to_cart_button_3.setMouseTracking(True)
        self.add_to_cart_button_3.setTabletTracking(True)
        self.add_to_cart_button_3.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.add_to_cart_button_3.setStyleSheet("QPushButton {\n"
" background-color: #10cc94;\n"
"border-radius:12px;\n"
"color:#fff;\n"
"}\n"
...
"border:none;\n"
"")
        self.add_to_cart_button_3.setIcon(icon1)
        self.add_to_cart_button_3.setIconSize(QtCore.QSize(22, 22))
        self.add_to_cart_button_3.setObjectName("add_to_cart_button_3")
        self.horizontalLayout.addWidget(self.add_to_cart_button_3)
...
"")
        ...
        self.label = QtWidgets.QLabel(Cart_Tab)
    ...
    def retranslateUi(self, Cart_Tab):
        ...
        self.add_to_cart_button_4.setText(_translate("Cart_Tab", "Clear Cart"))
        self.add_to_cart_button_2.setText(_translate("Cart_Tab", "Remove Item"))
        self.add_to_cart_button_3.setText(_translate("Cart_Tab", "Mark as Replacement"))
        self.add_to_cart_button.setText(_translate("Cart_Tab", "Check Out"))
        self.label.setText(_translate("Cart_Tab", "Total Price: ₱ 0.00"))
import logo_rc
