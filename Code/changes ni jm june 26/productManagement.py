...
class ProductsTab(QtWidgets.QWidget):
    ...
    def setup_ui(self):
        ...
        self.addProduct_button = QtWidgets.QPushButton("Add Product")
        ...
        self.modifyProduct_button = QtWidgets.QPushButton("Modify Product")
        ...
        self.changeStatus_button = QtWidgets.QPushButton("Change Status")
        self.changeStatus_button.setFont(font)
        self.changeStatus_button.setFixedHeight(40)  # Adjust height as needed
        self.changeStatus_button.clicked.connect(self.product_status)
        self.horizontalLayout_5.addWidget(self.changeStatus_button)
