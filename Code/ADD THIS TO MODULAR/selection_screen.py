...
class Ui_SelectionScreen(object):
    def setupUi(self, SelectionScreen):
        ...
        SelectionScreen.resize(870, 600)
        self.centralwidget = QtWidgets.QWidget(SelectionScreen)
        ...
        SelectionScreen.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(SelectionScreen)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 870, 22))
        self.menubar.setObjectName("menubar")
        SelectionScreen.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(SelectionScreen)
        self.statusbar.setObjectName("statusbar")
        SelectionScreen.setStatusBar(self.statusbar)
    ...
    def retranslateUi(self, SelectionScreen):
        ...
        SelectionScreen.setWindowTitle(_translate("SelectionScreen", "MainWindow"))
...
if __name__ == "__main__":
    ...
    SelectionScreen = QtWidgets.QMainWindow()
